# dortiz2025/sistema-reserva-clases
...
![Diagrama de Casos de Uso](diagramas/DiagramaCasosUso.png)
...
![Interfaz 1](diagramas/image.png)
![Interfaz 2](diagramas/image1.png)
![Interfaz 3](diagramas/image2.png)
![Interfaz 4](diagramas/image3.png)
...
![UML de Lógica](diagramas/UML_Logica.png)

A continuación, se expone un diagrama visual general del sistema:

![UML Visual](diagramas/umlVisual.jpg)
...
* **Creatividad y Mejoras:** Como un aporte de valor a la experiencia del usuario y a la flexibilidad del software, se implementó un motor de búsqueda multicriterio combinando los patrones Strategy y Composite para permitir búsquedas dinámicas avanzadas, superando el requerimiento básico de un filtro simple.

## 8. Problemas Identificados y Autocrítica
Durante el desarrollo, identificamos una ambigüedad en el dominio: la diferencia conceptual entre una "Clase" (el evento general del tutor) y una "Reserva" (el cupo individual del estudiante). Por restricciones de tiempo para esta entrega, optamos por un modelo donde la Reserva actúa directamente como el ticket individual, manejando las cancelaciones masivas iterando sobre las reservas afectadas. Como propuesta de mejora arquitectónica para una futura iteración, sugerimos separar la entidad "Clase" de la entidad "Reserva" para que ambas posean sus propios ciclos de vida y estados independientes.
